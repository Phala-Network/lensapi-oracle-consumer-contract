...
1. Create a template from the [`lensapi-oracle-consumer-contract`](https://github.com/Phala-Network/lensapi-oracle-consumer-contract) template repo. Click on the "**Use this template**" button in the top right corner of the webpage. Then skip the `npx @phala/fn init example` step.
